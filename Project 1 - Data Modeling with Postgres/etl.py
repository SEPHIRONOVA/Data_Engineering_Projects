...
def process_song_file(cur, filepath):
    '''
    - Read json file from song_file data 
    - Insert required data into corresponding table
    '''
    # open song file
...
def process_log_file(cur, filepath):
    ...
    - Process log_file
    - Format data
    - Insert required data into corresponding tables
    '''
    # open log file
    df = pd.read_json(filepath, lines=True)
    ...
    time_data = np.array([t.values, t.dt.hour.values, t.dt.day.values, t.dt.week.values, t.dt.month.values, t.dt.year.values, t.dt.weekday.values]).T
